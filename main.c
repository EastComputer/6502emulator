...
// DOS
#define DOS_START_ADDRESS 0x9d00
...
void drawTitle1( void ){
    ...
    mvprintw(line++, 0, "                               --------------------------                  ");
    mvprintw(line++, 0, "                               File Name    : ./ROM.bin                    ");
    mvprintw(line++, 0, "                               Load address : $D000                        ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "                               Please place program file at same directory.");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "       Boot program is not found.                                          ");
    mvprintw(line++, 0, "       > Please place boot program.                                        ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "       ");
    mvprintw(line++, 0, "       ");
...
void drawTitle2( void ){
    ...
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "       Boot program is ready.                                              ");
    mvprintw(line++, 0, "       > Please type [ Enter ]                                             ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "                                                                           ");
    mvprintw(line++, 0, "       ");
    mvprintw(line++, 0, "       ");
...
void title ( unsigned char *memory ){
    char buffer;
    //int loop1 = true;
    int loop2 = true;
    //while( loop1 ){
